         ...
         <div class="" v-if="attribute.attribute_values && attribute.attribute_values.length" v-for="attribute in product.attributes">
             <div class="">
                 ...
                 <div class="product-details">
                     <div class="mb-2 position-relative border-bottom">
                        ...
                        <label class="custom-control-label" :for="'attributeRadio_' + attributeValue.id">{{ attributeValue.value }}</label>
                             ...
                             <div class="form-check form-option form-check-inline">
                                 <input @change="checkVariant" :checked="index === 0" class="form-check-input" type="radio" :name="'items[' + product.id + '][attribute_' + attribute.id + ']'" :id="'attributeRadio_' + attributeValue.id" :value="attributeValue.id" data-bs-label="colorOption">
                                 <label class="form-option-label" :for="'attributeRadio_' + attributeValue.id">{{ attributeValue.value }}</label>
                             </div>
                         </template>
                     </div>
                 </div>
                 <div class="modal fade" :id="`guide-${attribute.id}`">
